Shader "Infinite Runner/Standard Curve"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			#pragma vertex vertForwardBaseCurve
			#pragma fragment fragForwardBase

			#include "UnityStandardCore.cginc"
			#include "StandardCurveCore.cginc"
		...
		Pass
		{
			...
			#pragma vertex vertDeferredCurve
	...
	FallBack "VertexLit"
	CustomEditor "StandardShaderCurveGUI"
}
